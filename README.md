...
├── README.md
├── data/
│   ├── dataset_originel.csv        ← Dataset brut (500 lignes, 10 colonnes)
...
> une mauvaise analyse en sortie. La qualité des données est le socle de toute décision métier fiable.
